require.config({
  ...
  shim: {
    ...
    "erfgeoviewer.mapmaker": { deps: ["erfgeoviewer.common", "backbone.marionette", "jquery"] },
    "erfgeoviewer.reader": { deps: ["erfgeoviewer.common", "backbone.marionette", "jquery"] },
